...
OUT=/your/path/to/workingdir/3.2-sero/sistr
...
{ head -n 1 ERR10395086-output.tab; tail -n +2 -q *.tab; } > sistr_output.txt # you will need to edit the SRR### to be an actual ID

cd ../cgmlst

{ head -n 1 ERR10395086_cgmlst-profiles.csv; tail -n +2 -q *profiles.csv; } > sistr_cgmlst.csv # you will need to edit the SRR### to be an actual ID
