...
TR="/your/path/to/workingdir/1.0-trimmed"
cd ${TR}

mkdir -p "/your/path/to/workingdir/2.1-k2filteredentero"

# --- Set variable paths
KRAKEN_DB="/your/path/to/kraken2/krakendbstandard"
KRAKEN2_DIR="/your/path/to/kraken2"
KRAKEN_TOOLS="/your/path/to/KrakenTools"
K2="/your/path/to/workingdir/2.0-kraken2" # kraken2 output directory
FILT="/your/path/to/workingdir/2.1-k2filteredentero" # extracted reads output directory
...
for file in *1P.fq.gz; do
   ...
   python ${KRAKEN_TOOLS}/extract_kraken_reads.py -t 543 \
    --include-children \
    -k ${K2}/${fname}.kraken2 \
