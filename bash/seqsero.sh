...
OUT=/your/path/to/workingdir/3.2-sero/seqsero
...
{ head -n 1 ERR10395086_seqsero/SeqSero_result.tsv; tail -n +2 -q *_seqsero/*_result.tsv; } > enteroseqsero_summary.tsv # you will need to edit the SRR### to be an actual ID
